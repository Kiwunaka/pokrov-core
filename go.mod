module github.com/Kiwunaka/POKROV-core
...
require (
	...
	github.com/Psiphon-Labs/utls v1.1.1-0.20260729134728-7a1fc711853d // indirect
...
replace github.com/sagernet/sing-box => ./engine/sing-box

replace github.com/sagernet/wireguard-go => ./engine/sing-box/replace/wireguard-go

replace github.com/sagernet/tailscale => ./engine/sing-box/replace/tailscale
