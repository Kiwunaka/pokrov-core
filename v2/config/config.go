...
func BuildConfigJson(ctx context.Context, configOpt *PokrovOptions, input *ReadOptions) ([]byte, error) {
...
func ParseBuildConfigBytes(ctx context.Context, hopts *PokrovOptions, input *ReadOptions) ([]byte, error) {
...
func ParseBuildConfig(ctx context.Context, hopts *PokrovOptions, input *ReadOptions) (*option.Options, error) {
