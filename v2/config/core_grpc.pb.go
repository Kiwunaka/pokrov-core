...
const (
	CoreService_ParseConfig_FullMethodName        = "/pokrovoptions.CoreService/ParseConfig"
	CoreService_GenerateFullConfig_FullMethodName = "/pokrovoptions.CoreService/GenerateFullConfig"
)
...
func (c *coreServiceClient) ParseConfig(ctx context.Context, in *ParseConfigRequest, opts ...grpc.CallOption) (*ParseConfigResponse, error) {
	...
	err := c.cc.Invoke(ctx, CoreService_ParseConfig_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *coreServiceClient) GenerateFullConfig(ctx context.Context, in *GenerateConfigRequest, opts ...grpc.CallOption) (*GenerateConfigResponse, error) {
	...
	err := c.cc.Invoke(ctx, CoreService_GenerateFullConfig_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var CoreService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "pokrovoptions.CoreService",
