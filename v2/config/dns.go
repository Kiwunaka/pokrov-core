...
func setDns(options *option.Options, opt *PokrovOptions, staticIps *map[string][]string) error {
...
func addForceDirect(options *option.Options, hopt *PokrovOptions) ([]option.DefaultDNSRule, error) {
