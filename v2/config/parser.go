...
import (
	...
	"github.com/Kiwunaka/POKROV-core/ray2sing/ray2sing"
...
func ParseConfig(ctx context.Context, opt *ReadOptions, debug bool, configOpt *PokrovOptions, fullConfig bool) (*option.Options, error) {
...
func parseConfigContent(ctx context.Context, content []byte, debug bool, configOpt *PokrovOptions, fullConfig bool) (*option.Options, error) {
	if configOpt == nil {
		configOpt = DefaultPokrovOptions()
	}
