...
func patchOutboundMux(base option.Outbound, configOpt PokrovOptions, obj outboundMap) outboundMap {
...
func patchOutboundTLSTricks(base option.Outbound, configOpt PokrovOptions) option.Outbound {
...
func patchOutboundFragment(base option.Outbound, configOpt PokrovOptions) option.Outbound {
...
func patchEndpoint(base *option.Endpoint, configOpt PokrovOptions, staticIPs *map[string][]string) (*option.Endpoint, error) {
...
func patchOutbound(base option.Outbound, configOpt PokrovOptions, staticIPs *map[string][]string) (*option.Outbound, error) {
...
// func patchOutboundXray(base option.Outbound, configOpt PokrovOptions, staticIpsDns map[string][]string) outboundMap {
