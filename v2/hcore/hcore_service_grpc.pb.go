...
const (
	...
	Core_ChangePokrovSettings_FullMethodName  = "/hcore.Core/ChangePokrovSettings"
...
type CoreClient interface {
	...
	ChangePokrovSettings(ctx context.Context, in *ChangePokrovSettingsRequest, opts ...grpc.CallOption) (*CoreInfoResponse, error)
...
func (c *coreClient) ChangePokrovSettings(ctx context.Context, in *ChangePokrovSettingsRequest, opts ...grpc.CallOption) (*CoreInfoResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CoreInfoResponse)
	err := c.cc.Invoke(ctx, Core_ChangePokrovSettings_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CoreServer interface {
	...
	ChangePokrovSettings(context.Context, *ChangePokrovSettingsRequest) (*CoreInfoResponse, error)
	// rpc GenerateConfig (GenerateConfigRequest) returns (GenerateConfigResponse);
...
func (UnimplementedCoreServer) ChangePokrovSettings(context.Context, *ChangePokrovSettingsRequest) (*CoreInfoResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ChangePokrovSettings not implemented")
}
...
func _Core_ChangePokrovSettings_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ChangePokrovSettingsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CoreServer).ChangePokrovSettings(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Core_ChangePokrovSettings_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CoreServer).ChangePokrovSettings(ctx, req.(*ChangePokrovSettingsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Core_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ChangePokrovSettings",
			Handler:    _Core_ChangePokrovSettings_Handler,
		},
		{
