...
import (
	...
	service_manager "github.com/Kiwunaka/POKROV-core/v2/service_manager"
...
func StartService(ctx context.Context, in *StartRequest) (coreResponse *CoreInfoResponse, err error) {
	...
	if !in.EnableRawConfig && static.PokrovOptions == nil {
		return errorWrapper(
			MessageType_ERROR_BUILDING_CONFIG,
			errors.New("PokrovOptions not initialized"),
		)
	}
