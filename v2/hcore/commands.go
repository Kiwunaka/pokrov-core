...
func (h *PokrovInstance) readStatus(prev *SystemInfo) *SystemInfo {
...
func (h *PokrovInstance) MakeSureContextIsNew(streamContext context.Context) {
	for range 10 {
...
func (h *PokrovInstance) GetSystemInfo(stream grpc.ServerStreamingServer[SystemInfo]) error {
...
func (h *PokrovInstance) UrlTestActive() (*hcommon.Response, error) {
	if box := h.Box(); box != nil {
...
func (h *PokrovInstance) UrlTest(in *UrlTestRequest) (*hcommon.Response, error) {
	if in.Tag == "" {
