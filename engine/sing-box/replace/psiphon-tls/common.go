...
type ConnectionState struct {
	...
	// HelloRetryRequest indicates whether a HelloRetryRequest was sent or received.
	// Its position mirrors crypto/tls.ConnectionState in the pinned Go 1.26 toolchain.
